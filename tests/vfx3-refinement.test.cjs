...
function geometryRuntime(){
 ...
 vm.runInContext(fs.readFileSync('src/vfx3/skyfall.js','utf8'),ctx);vm.runInContext(fs.readFileSync('src/vfx3/benchmark-arts.js','utf8'),ctx);vm.runInContext(fs.readFileSync('src/vfx3/sword-arts.js','utf8'),ctx);vm.runInContext(fs.readFileSync('src/vfx3/remaster-arts.js','utf8'),ctx);vm.runInContext(fs.readFileSync('src/vfx3/lifecycle-arts.js','utf8'),ctx);vm.runInContext(fs.readFileSync('src/vfx3/runtime.js','utf8'),ctx);return ctx.EmberVFX3.create({});
}

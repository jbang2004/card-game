...
(()=>{
 ...
 window.AtelierDiagnostics={version:'0.13.0',assets:Object.keys(WindborneAssets).length,paintedCards:AtelierArt.paintedCards.length,buildings:4,frames:0,layout:'1600x940',input:'live DOM',renderer:'Canvas 2D'};
})();
